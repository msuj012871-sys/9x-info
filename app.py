...
def get_account_credentials(region: str) -> str:
    ...
    if r == "ME":
        ...
        return "uid=4499370173&password=8B5AF77C88F79110E8065C52F33285E677D0CF3904A5DAE0BCF0B95C485A8AC9"
...
def run_startup():
    """Run token initialization synchronously"""
    asyncio.run(initialize_tokens())
    # Note: periodic refresh won't run automatically in this setup.
    # For local, you can start a background thread, but not needed for basic usage.
